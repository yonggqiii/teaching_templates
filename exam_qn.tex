...
% if you want to remove the pre-defined instructions, simply issue the \clearinstructions command before the instructions environment.
% \clearinstructions

\begin{instructions}
    % page count, question count, total score, total weightage and plagiarism/cheating notice are already pre-loaded unless you used \clearinstructions
    % if you want to show the number of questions and pages in this document, use the \totalquestions and \numpages commands respectively. For example:
    % \item There are \totalquestions\ questions and \numpages\ pages.
